...
> Note: the sections below still describe the state at Phase 5.1 (2026-09-17) and are stale in two known places — `CURRENT_SETTINGS_VERSION` is 5, not 3, and the suite is 864 tests in 33 files, not 340 in 15. The ZotFlow annotation work and the template library are not reflected in them.
