...
> Note: the sections below still describe the state at Phase 5.1 (2026-09-17) and are stale in two known places — `CURRENT_SETTINGS_VERSION` is 5, not 3, and the suite is 792 tests in 32 files, not 340 in 15. The ZotFlow annotation work and the template library are not reflected in them.
